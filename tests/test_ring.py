...
def mock_ring_requests():
    with requests_mock.Mocker() as mock:
        ...
        mock.get('https://api.ring.com/clients_api/doorbots/999999/health',
                 text=load_fixture('ring_doorboot_health_attrs.json'))
        mock.get('https://api.ring.com/clients_api/doorbots/999999/history',
        ...
        mock.put('https://api.ring.com/clients_api/doorbots/999999/floodlight_light_off',
                 text='ok')
        mock.put('https://api.ring.com/clients_api/doorbots/999999/floodlight_light_on',
                 text='ok')
        mock.put('https://api.ring.com/clients_api/doorbots/999999/siren_on',
                 text='ok')
        mock.put('https://api.ring.com/clients_api/doorbots/999999/siren_off',
                 text='ok')
        yield mock
...
def test_stickup_cam_controls(ring, mock_ring_requests):
    ...
    history = list(filter(lambda x: x.method == 'PUT',
                          mock_ring_requests.request_history))
