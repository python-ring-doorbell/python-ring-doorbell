...
DOORBELL_BATTERY_KINDS = ["df_doorbell_clownfish", "hp_doorbell"]
DOORBELL_BATTERY_PLUS_KINDS = ["doorbell_v2"]
DOORBELL_BATTERY_PRO_KINDS = ["doorbell_graham"]
...
OUTDOOR_CAM_PLUS_KINDS = ["outdoor_cam_plus"]
OUTDOOR_CAM_PRO_KINDS = ["outdoor_cam_pro"]
