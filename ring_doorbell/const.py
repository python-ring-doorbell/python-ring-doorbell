...
DOORBELL_BATTERY_KINDS = ["df_doorbell_clownfish", "cocoa_doorbell_v4", "cocoa_doorbell_v5"]
DOORBELL_BATTERY_PLUS_KINDS = ["cocoa_doorbell_v6"]
DOORBELL_BATTERY_PRO_KINDS = ["cocoa_doorbell_v7"]
...
OUTDOOR_CAM_PLUS_KINDS = ["cocoa_camera_v4"]
OUTDOOR_CAM_PRO_KINDS = ["cocoa_camera_v3", "cocoa_camera_v5"]
